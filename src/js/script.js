...
async function applyFilters() {
    ...
    await axios
        .get("https://672b1e6c976a834dd025b2ee.mockapi.io/attractions")
        .then((response) => {
...
//     axios
//         .get(
//             `https://672b1e6c976a834dd025b2ee.mockapi.io/attractions?page=${p}&limit=${itemsPerPage}&category=${localStorage.getItem("category")}&title=${localStorage.getItem("searchInput")}`,
//         )
//         .then(function (response) {
